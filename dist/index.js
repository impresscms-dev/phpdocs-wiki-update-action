  ...
  return source;
    ...
    /***/ ((__unused_webpack_module, exports, __nccwpck_require__) => {
      ...
      class GeneratorActionStepDefinition {
         ...
         */
        exec() {
          (0, core_1.info)(this.description);
    ...
    /***/ (function (__unused_webpack_module, exports, __nccwpck_require__) {
      ...
      const TempPaths_1 = __importDefault(__nccwpck_require__(2844));
      const Composer_1 = __importDefault(__nccwpck_require__(8166));
      ...
      class BackupComposerFilesAction {
        ...
        exec() {
          ...
          this.backupFile((0, path_1.join)(globalPath, 'composer.lock'), 'composer-global-backup');
          this.backupFile('composer.json', 'composer-local-backup');
          this.backupFile((0, path_1.join)(globalPath, 'composer.json'), 'composer-global-backup');
          this.backupFile((0, path_1.join)(globalPath, 'config.json'), 'composer-global-backup');
        }
        ...
        backupFile(file, dstType) {
          ...
          (0, fs_1.copyFileSync)(file, TempPaths_1.default.getFilename(dstType, fileName));
        }
      }
    ...
    /***/ (function (__unused_webpack_module, exports, __nccwpck_require__) {
      ...
      Object.defineProperty(exports, "__esModule", ({value: true}));
      const TempPaths_1 = __importDefault(__nccwpck_require__(2844));
      const Execution_1 = __importDefault(__nccwpck_require__(1507));
    ...
    /***/ (function (__unused_webpack_module, exports, __nccwpck_require__) {
      ...
      const fs_1 = __nccwpck_require__(7147);
      const path_1 = __nccwpck_require__(1017);
      const GitInfo_1 = __importDefault(__nccwpck_require__(2802));
      const TempPaths_1 = __importDefault(__nccwpck_require__(2844));
      const Execution_1 = __importDefault(__nccwpck_require__(1507));
      const OldDocsDirExistButShouldntError_1 = __importDefault(__nccwpck_require__(5129));
      ...
      class CloneWikiAction {
        ...
        exec() {
          ...
          if ((0, fs_1.existsSync)(oldDocsDir)) {
            throw new OldDocsDirExistButShouldntError_1.default(oldDocsDir);
          }
          (0, fs_1.mkdirSync)(oldDocsDir);
          Execution_1.default.run('git', [
            ...
            (0, path_1.basename)(oldDocsDir)
          ], (0, path_1.dirname)(oldDocsDir));
         ...
         */
        getUpdateToken() {
          return (0, core_1.getInput)('wiki_github_update_token', {required: true});
        }
         ...
         */
        getUpdateUser() {
          return (0, core_1.getInput)('wiki_github_update_user', {required: true});
        }
      ...
      class CommitAction {
        ...
        exec() {
          ...
          try {
            ...
            (0, core_1.debug)('Nothing to commit');
          }
        }
      }
    ...
    /***/ (function (__unused_webpack_module, exports, __nccwpck_require__) {
      ...
      const TempPaths_1 = __importDefault(__nccwpck_require__(2844));
      const Execution_1 = __importDefault(__nccwpck_require__(1507));
      const readDirSync = __nccwpck_require__(695);
    ...
    exec() {
      ...
      for (const newFilename in filenames) {
        ...
        fixesToNewStyleLinks(filename, filenames) {
          (0, core_1.debug)(` Fixing ${filename}...`);
          ...
          for (const oldFilename in filenames) {
            ...
            if ((0, path_1.extname)(winFilename) === '.md') {
        ...
        renameFile(newDocs, oldFilename, newFilename) {
          (0, core_1.debug)(` Renaming ${oldFilename} -> ${newFilename}...`);
          (0, fs_1.renameSync)(newDocs.concat('/', oldFilename), newDocs.concat('/', newFilename));
        }
    ...
    exec(generator) {
      ...
      TempPaths_1.default.addSubpathAlias('old-docs-workdir', 'old-docs-main', (0, core_1.getInput)('workdir', {required: false}));
      TempPaths_1.default.addSubpathAlias('new-docs-workdir', 'new-docs-main', (0, core_1.getInput)('workdir', {required: false}));
      ...
      class PrefixAction {
        ...
        exec() {
          ...
          for (const file of readDirSync(newDocs)) {
            (0, core_1.debug)(`  ${file.toString()}`);
            const content = (0, fs_1.readFileSync)(file.toString(), 'utf8');
            const newContent = prefix.concat(content
              .split(/\n/g)
              .map(line => line.trimRight())
              .join(os_1.EOL));
            (0, fs_1.writeFileSync)(file.toString(), newContent);
          }
        }
         ...
         */
        getPrefixLines() {
          let lines = (0, core_1.getInput)('prefix_lines', {required: false});
    ...
    restoreFile(shortFilename, srcType, dstPath) {
      ...
      if (!(0, fs_1.existsSync)(bkpFilename)) {
        return;
      }
      const dstFile = (0, path_1.join)(dstPath, shortFilename);
      if ((0, fs_1.existsSync)(dstFile)) {
        (0, fs_1.unlinkSync)(dstFile);
      }
      (0, fs_1.renameSync)(bkpFilename, dstFile);
    }
      }
    ...
    /***/ (function (__unused_webpack_module, exports, __nccwpck_require__) {
      ...
      Object.defineProperty(exports, "__esModule", ({value: true}));
      const core_1 = __nccwpck_require__(2186);
      const ConfigItemMustBeAtLeastCharactersError_1 = __importDefault(__nccwpck_require__(882));
      ...
      class ValidateMainParamsAction {
         ...
         */
        exec() {
          (0, core_1.getInput)('wiki_github_update_user', {required: true});
          if ((0, core_1.getInput)('wiki_github_update_token', {
            required: true
          }).length < 40) {
            throw new ConfigItemMustBeAtLeastCharactersError_1.default('wiki_github_update_token', 40);
          }
        }
      }
    ...
    /***/ (function (__unused_webpack_module, exports, __nccwpck_require__) {
      ...
      Object.defineProperty(exports, "__esModule", ({value: true}));
      const install_1 = __importDefault(__nccwpck_require__(432));
      const clone_wiki_1 = __importDefault(__nccwpck_require__(1932));
      const exec_before_generator_actions_1 = __importDefault(__nccwpck_require__(3522));
      const generate_1 = __importDefault(__nccwpck_require__(5450));
      const exec_after_generator_actions_1 = __importDefault(__nccwpck_require__(7979));
      const flatten_file_structure_1 = __importDefault(__nccwpck_require__(8439));
      const prefix_1 = __importDefault(__nccwpck_require__(9481));
      const copy_old_git_data_to_new_place_1 = __importDefault(__nccwpck_require__(8574));
      const configure_commit_author_1 = __importDefault(__nccwpck_require__(2372));
      const check_status_1 = __importDefault(__nccwpck_require__(7522));
      const commit_1 = __importDefault(__nccwpck_require__(5045));
      const push_update_1 = __importDefault(__nccwpck_require__(9434));
      const uninstall_1 = __importDefault(__nccwpck_require__(3822));
      const remove_not_required_files_1 = __importDefault(__nccwpck_require__(7376));
      const global_install_1 = __importDefault(__nccwpck_require__(4374));
      const global_uninstall_1 = __importDefault(__nccwpck_require__(1986));
      const global_set_config_1 = __importDefault(__nccwpck_require__(5464));
      const set_config_1 = __importDefault(__nccwpck_require__(494));
      const backup_composer_files_action_1 = __importDefault(__nccwpck_require__(452));
      const restore_composer_files_1 = __importDefault(__nccwpck_require__(3750));
      const init_tmp_paths_1 = __importDefault(__nccwpck_require__(8789));
      const validate_main_params_1 = __importDefault(__nccwpck_require__(2573));
      const actions = [
    ...
    /***/ (function (__unused_webpack_module, exports, __nccwpck_require__) {
      ...
      Object.defineProperty(exports, "__esModule", ({value: true}));
      const clean_phpdoc_md_1 = __importDefault(__nccwpck_require__(2059));
      const evert_phpdoc_md_1 = __importDefault(__nccwpck_require__(1231));
      const generators = {
    ...
    /***/ ((__unused_webpack_module, exports) => {
      ...
      class default_1 extends TypeError {
        constructor() {
          super('Unknown selected generator name');
        }
      }
    ...
    /***/ ((__unused_webpack_module, exports) => {
      ...
      class default_1 extends Error {
        constructor(dir) {
          super(dir.concat(" already exists but shouldn't"));
        }
      }
    ...
    /***/ ((__unused_webpack_module, exports) => {
      ...
      class default_1 extends Error {
        constructor(path) {
          super(path.concat(" path is already added"));
        }
      }
    ...
    /***/ ((__unused_webpack_module, exports) => {
      ...
      class default_1 extends Error {
        constructor(path) {
          super(path.concat(" is not yet added"));
        }
      }
    ...
    /***/ (function (__unused_webpack_module, exports, __nccwpck_require__) {
      ...
      const os_1 = __nccwpck_require__(2037);
      const path_1 = __nccwpck_require__(1017);
      const GeneratorActionStepDefinition_1 = __importDefault(__nccwpck_require__(6148));
      const TempPaths_1 = __importDefault(__nccwpck_require__(2844));
      const Execution_1 = __importDefault(__nccwpck_require__(1507));
      const Composer_1 = __importDefault(__nccwpck_require__(8166));
      const picomatch = __nccwpck_require__(8569);
      const NoClassesMatchesIncludeRulesError_1 = __importDefault(__nccwpck_require__(4679));
      ...
      class default_1 {
        ...
        checkIfAllInputOptionsDefined() {
          return ((0, core_1.getInput)('class_root_namespace', {required: true}).length > 0 &&
            (0, core_1.getInput)('include', {required: true}).length > 0);
        }
        ...
        getAfterActions() {
          return [
            ...
            new GeneratorActionStepDefinition_1.default(null, 'Deleting config...', fs_1.unlinkSync, (0, path_1.join)(process.cwd(), '.phpdoc-md'))
          ];
        }
        ...
        getBeforeActions() {
          return [
            new GeneratorActionStepDefinition_1.default(this, 'Generating generator config...', this.generateConfig, process.cwd(), (0, core_1.getInput)('class_root_namespace', {required: true}), (0, core_1.getInput)('include', {required: true})
              .replace(/\n/g, os_1.EOL)
              .split(os_1.EOL)
              .map(x => x.trim())
        ...
        generateConfig(cwd, rootNamespace, include, tempDocsPath) {
          ...
          const classes = this.readComposerConfig()
            ...
            .map(key => key.replace(/\//g, '\\'));
          (0, core_1.debug)('Include rules:');
          if (changedIncludeRules.length > 0) {
            for (const rule of changedIncludeRules) {
              (0, core_1.debug)('  [*] '.concat(rule).replace(/\//g, '\\'));
            }
          } else {
            (0, core_1.debug)('  (none)');
          }
          (0, core_1.debug)('Do not include rules:');
          ...
          if (classes.length === 0) {
            throw new NoClassesMatchesIncludeRulesError_1.default();
          }
          ...
          (0, core_1.debug)('Generated config:');
          for (const line of generated.split('\n')) {
            (0, core_1.debug)(line.replace(/~+$/g, '').replace(/\r/g, ''));
          }
          (0, fs_1.writeFileSync)(cwd.concat('/.phpdoc-md'), generated);
        }
    ...
    /***/ (function (__unused_webpack_module, exports, __nccwpck_require__) {
      ...
      class default_1 {
        ...
        generateXML(dstPath, cachePath) {
          ...
          const cmd = Execution_1.default.replaceWinPathCharToUnix(Execution_1.default.suffixExtIfRunningOnWindows((0, path_1.join)(path, 'vendor', 'bin', 'phpdoc')));
          const args = [
            '--cache-folder',
    ...
    /***/ (function (__unused_webpack_module, exports, __nccwpck_require__) {
      ...
      const os_1 = __nccwpck_require__(2037);
      const ExecutionFailedError_1 = __importDefault(__nccwpck_require__(6499));
      ...
      class ExecutionHandler {
        ...
        printRunningCommand(cmd, args, cwd, env) {
          ...
          (0, core_1.debug)(` Executing ${fullCommand} in ${cwd}...`);
        }
        ...
        getResults(cmd, args, cwd, env = {}) {
          ...
          const proc = (0, child_process_1.spawnSync)(cmd, args, {cwd, env: envOptions});
          const out = (_a = proc.output) === null || _a === void 0 ? void 0 : _a.join('\n').trim().replace(/\n/g, os_1.EOL);
          for (const outputLine of out.split(os_1.EOL)) {
            (0, core_1.debug)(outputLine.trim());
          }
          if (proc.status === 0) {
            return out;
          }
          throw new ExecutionFailedError_1.default(out);
        }
    ...
    /***/ (function (__unused_webpack_module, exports, __nccwpck_require__) {
      ...
      const path_1 = __nccwpck_require__(1017);
      const core_1 = __nccwpck_require__(2186);
      const PathAlreadyAddedError_1 = __importDefault(__nccwpck_require__(3285));
      const PathIsNotYetAddedError_1 = __importDefault(__nccwpck_require__(3791));
      ...
      class TempPathsHandler {
        ...
        add(type, create = true) {
          if (this.isSet(type)) {
            throw new PathAlreadyAddedError_1.default(type);
          }
          this.paths[type] = this.generateUniqueTmpDirPath(type);
          if (create) {
            (0, fs_1.mkdirSync)(this.paths[type]);
          }
        }
        ...
        generateUniqueTmpDirPath(type) {
          let path;
          const tmpPathBase = (0, os_1.tmpdir)();
          const hash = (0, crypto_1.createHash)('sha1');
          while ((0, fs_1.existsSync)((path = (0, path_1.join)(tmpPathBase, type.concat('-', hash.update(Date.now().toString()).digest('hex'))))))
            ;
          return path;
        }
        ...
        get(type) {
          if (!this.isSet(type)) {
            throw new PathIsNotYetAddedError_1.default(type);
          }
         ...
         */
        debug() {
          (0, core_1.debug)(`Registered paths:`);
          for (const type in this.paths) {
            (0, core_1.debug)(`  ${type} = ${this.paths[type]}`);
          }
        }
        ...
        addSubpathAlias(type, originalType, path) {
          ...
          if (!this.isSet(originalType)) {
            throw new PathIsNotYetAddedError_1.default(originalType);
          }
          this.paths[type] = (0, path_1.join)(this.get(originalType), path);
        }
        ...
        getFilename(type, relativePath) {
          return (0, path_1.join)(this.get(type), relativePath);
        }
      }
    ...
    /***/ (function (__unused_webpack_module, exports, __nccwpck_require__) {
      ...
      Object.defineProperty(exports, "__esModule", ({value: true}));
      const core_1 = __nccwpck_require__(2186);
      const actions_1 = __importDefault(__nccwpck_require__(4453));
      const generators_1 = __importDefault(__nccwpck_require__(1774));
      const UnknownSelectedGeneratorNameError_1 = __importDefault(__nccwpck_require__(9001));
      const NotAllRequiredArgumentsDefinedForSelectedEngineError_1 = __importDefault(__nccwpck_require__(7696));
      try {
        const generatorName = (0, core_1.getInput)('engine', {required: false});
        if (typeof generators_1.default[generatorName] == 'undefined') {
          throw new UnknownSelectedGeneratorNameError_1.default();
        }
        const generator = generators_1.default[generatorName];
        if (!generator.checkIfAllInputOptionsDefined()) {
          throw new NotAllRequiredArgumentsDefinedForSelectedEngineError_1.default();
        }
